<template>
    <g>
        <svg viewBox="0 0 83 75" width="83" height="75" x="48.05" y="64.94">
            ...
            <text class="pet-font" transform="translate(4.87 30.99)">Level</text>
            <text class="pet-font svg-text-right-direction" transform="translate(78 30.99)" >{{navi.level}}</text>
            <text class="pet-font" transform="translate(4.87 50.1)">EXP</text>
            <text class="pet-font svg-text-right-direction" transform="translate(78 50.1)" >{{navi.exp}}</text>

            <text class="pet-font" transform="translate(4.87 70.1)">CP</text>
            <text class="pet-font svg-text-right-direction" transform="translate(78 70.1)" >{{navi.cp}}</text>
...
export default {
    ...
    methods: {
        ...
        onRight() {
            this.$store.commit('session/setCurrentScene', SceneNames.NaviStageDetails);
        },
        onLeft() {
            this.$store.commit('session/setCurrentScene', SceneNames.NaviStatusDetails);
        },
        onCancel() {
