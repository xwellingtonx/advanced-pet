...
var allWorlds = [
    {   
        ...
        description: "Based on Advanced PET Megaman Version",
        stages: [
            {
                id: 1,
                stageClear: 10,
    ...
    },
    {
        ...
        description: "Based on Advanced PET Protoman Version",
        stages: [
            {
                id: 1,
                stageClear: 10,
    ...
    {   
        deviceType: DeviceTypes.Bass,
        description: "Based on Advanced PET Bass Version",
        stages: [
            {
                id: 1,
                stageClear: 10,
