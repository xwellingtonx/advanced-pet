<template>
    <g>
      <svg viewBox="0 0 83 75" width="83" height="75" x="48.05" y="64.94">
        ...
        <text class="cls-1" transform="translate(4.87 27.99)">CP</text>
        <text class="cls-1" transform="translate(65.4 27.99)" v-if="pluggedChip">{{pluggedChip.CP}}</text>
        <text class="cls-1" transform="translate(4.87 47.1)">AT</text>
        <text class="cls-1" transform="translate(65.4 47.1)" v-if="pluggedChip">{{pluggedChip.AT}}</text>
...
.cls-1{font-size:10px;font-family:Advanced-PET-Font, Advanced PET Font;}.cls-1,.cls-2{fill:#fff;}
</style>