    ...
    <div class="advanced-pet megaman-bg">
        <div class="cover-container">
            <svg viewBox="0 0 179.06 248"> 
                <g class="cover-opened-group">
                    <path class="base-color" d="M152.23,67h-10.9V52A51.9,51.9,0,0,0,89.53,0h0a51.9,51.9,0,0,0-51.8,52V67H3.06V236.5H13.27V248H165.76V236.5H176V67ZM137,199.35H41.66V113.6a3.93,3.93,0,0,1,3.93-3.93h87.53A3.92,3.92,0,0,1,137,113.6Z" />
                    <path class="base-color-shadow" d="M176.06,214.18V205.7h0V67H141.31V51.78A51.78,51.78,0,0,0,89.53,0h0A51.78,51.78,0,0,0,37.75,51.78V67H3.06V214.17c-1.69,0-3.06,5-3.06,11.16S1.37,236.5,3.06,236.5v5.15a6.35,6.35,0,0,0,6,6.35H23.4V208.7L9.06,202.48V73H43.73V51.79A45.79,45.79,0,0,1,89.52,6h0a45.79,45.79,0,0,1,45.79,45.79V73h34.75V202.48l-14.37,6.22V248h15v-.06a6.36,6.36,0,0,0,5.39-6.29v-5.16c1.67-.13,3-5.07,3-11.16S177.73,214.3,176.06,214.18Z" />
                    <g class="megaman-logo" v-on:click="this.closeCover">
                        <circle class="logo-out-circle-color" cx="89.87" cy="52.65" r="35.62" />
                        <circle cx="89.87" cy="52.65" r="32.11" />
                        <path class="logo-icon-color" d="M80.71,61.66,98,42.7l-.43-19.65A30.58,30.58,0,0,0,61.11,63Z" />
                        <path class="logo-icon-color" d="M118.63,42.26,99,43.64l-17.29,19,.43,19.65a30.58,30.58,0,0,0,36.47-40Z" />
                    </g>
                </g>
            </svg>
        ...
        <div class="body-container" :style="this.isCoverOpened === true ? 'margin-top: -88px;' : ''">
            <svg viewBox="0 0 244.82 316.16">
                <g class="frame-group">
                        <path class="frame-color" d="M176,181.73v-133h0V107.3H155.6V9.35H142.31a4.84,4.84,0,0,0-4.84,4.83v1.55h0V26.06a8.5,8.5,0,0,1-8.5,8.5H50.22a8.5,8.5,0,0,1-8.5-8.5V14.18a4.83,4.83,0,0,0-4.83-4.83H23.3v39.3h0v58.66H3v74.42H9v25.6a80.38,80.38,0,0,0,80.38,80.38h0a80.38,80.38,0,0,0,80.38-80.38v-1.14h0V181.73Z" />
                        <polygon class="handle-color-shadow" points="155.59 48.72 155.59 107.31 169.91 107.31 169.91 175.73 169.72 175.73 166.72 175.73 163.72 175.73 163.72 187.73 163.72 216.19 169.72 216.19 169.72 187.73 169.72 181.73 169.91 181.73 172.72 181.73 175.91 181.73 175.91 107.31 175.97 107.31 175.97 48.72 155.59 48.72" />
                        <polygon class="handle-color-shadow" points="23.34 107.31 23.34 48.65 2.97 48.65 2.97 107.31 2.97 181.73 8.97 181.73 8.97 181.77 8.97 216.19 14.97 216.19 14.97 181.77 14.97 175.73 8.97 175.73 8.97 107.31 23.34 107.31" />
                        <rect class="handle-color" x="15.72" y="196.42" width="31.25" height="51.71" rx="15.62" ry="15.62" />
                ...
                <g class="screen-opened-group">
                    ...
                    <text class="logo-out-circle-color" transform="translate(57.05 151.07) scale(1.27 1)">ADVANCED</text>
                </g>
                ...
                <g class="slider-group">
                    <path class="base-color" d="M142.31,182.7v22.12a52,52,0,0,1-52,52h0a52,52,0,0,1-52-52V182.7H3.81v22a86.5,86.5,0,0,0,86.5,86.5h0a86.5,86.5,0,0,0,86.5-86.5v-22Z" />
                    <path class="base-color-shadow2" d="M126,182.7v21.64a35.87,35.87,0,0,1-25.31,34.35v17.65A52.3,52.3,0,0,0,142.31,205V182.7Z" />
                    <path class="base-color-shadow2" d="M80.23,238.75a35.85,35.85,0,0,1-25.51-34.41V182.7H38.31V205a52.3,52.3,0,0,0,41.92,51.39Z" />
                    <path class="base-color-shadow" d="M142.31,204.82a52,52,0,0,1-52,52h0a52,52,0,0,1-52-52V182.7h-6.5v21.12a58.34,58.34,0,0,0,58.34,58.34h0a58.34,58.34,0,0,0,58.33-58.34V182.7h-6.17Z" />
                    <rect class="base-color-shadow" x="152.06" y="201.13" width="20.5" height="5.88" rx="2.94" ry="2.94" transform="translate(324.63 408.14) rotate(-180)" />
                    <rect class="base-color-shadow" x="8.06" y="201.13" width="20.5" height="5.88" rx="2.94" ry="2.94" transform="translate(36.63 408.14) rotate(-180)" />
                    <rect class="base-color-shadow" x="17.33" y="236.85" width="20.5" height="5.88" rx="2.94" ry="2.94" transform="translate(171.37 433.67) rotate(150)" />
                ...
                <g class="cover-closed-group">
                    ...
                    <path class="base-color-shadow" d="M119.93,37.45H59.36A9.19,9.19,0,0,1,51,32L37.9,2.78H141.4L128.31,32A9.19,9.19,0,0,1,119.93,37.45Z" />
                    <path class="base-color-shadow" d="M141.4,2.78H37.9L40.31.18A.59.59,0,0,1,40.72,0h97.85a.59.59,0,0,1,.41.18Z" />
                    <path class="base-color" d="M118.31,32.94H61a8.88,8.88,0,0,1-8.11-5.26L40.58.23A.16.16,0,0,1,40.73,0h97.83a.16.16,0,0,1,.15.23L126.43,27.68A8.9,8.9,0,0,1,118.31,32.94Z" />
                    <path class="base-color-shadow" d="M9.06,151.78V2.8a6.33,6.33,0,0,0-6,6.32V175.53h34.5Z" />
                    <path class="base-color-shadow" d="M172.51,3.43l-.08,0-.36-.15-.2-.08-.26-.08c-.11,0-.21-.07-.32-.09l-.16,0-.44-.09h-.06a4.52,4.52,0,0,0-.53-.06h0v149l-28.5,23.75h34.5V9.12h0A6.32,6.32,0,0,0,172.51,3.43Z" />
                    <path class="logo-out-circle-color" d="M150.11,2.78h-.05V149.45h.05L127.4,168.78v36a37.84,37.84,0,0,1-37.84,37.84h0a37.84,37.84,0,0,1-37.83-37.84v-36L29.78,149.45h-.05V2.78H20.31V153.87l23.26,18.58h-.51v32.17a46.25,46.25,0,0,0,46.25,46.25h0a46.25,46.25,0,0,0,46.25-46.25V172.45h0l23.26-18.58V2.78Z" />
                    <path class="logo-out-circle-color" d="M149,1.26h9.81a0,0,0,0,1,0,0v0a1.52,1.52,0,0,1-1.52,1.52h-6.77A1.52,1.52,0,0,1,149,1.26v0A0,0,0,0,1,149,1.26Z" transform="translate(307.81 4.04) rotate(-180)" />
                    <path class="logo-out-circle-color" d="M21.83,1.26H28.6a1.52,1.52,0,0,1,1.52,1.52v0a0,0,0,0,1,0,0H20.31a0,0,0,0,1,0,0v0A1.52,1.52,0,0,1,21.83,1.26Z" />
                    <g class="megaman-logo" v-on:click="this.openCover">
                        <circle class="logo-out-circle-color" cx="89.58" cy="204.47" r="35.62" />
                        <circle cx="89.58" cy="204.47" r="32.11" />
                        <path class="logo-icon-color" d="M80.43,213.48l17.29-19-.43-19.64a30.58,30.58,0,0,0-36.47,40Z" />
                        <path class="logo-icon-color" d="M118.34,194.08l-19.6,1.38L81.45,214.41l.43,19.65a30.57,30.57,0,0,0,36.46-40Z" />
                    </g>
                    <path class="base-color-shadow" d="M176.06,15c1.69,0,3.07,5,3.07,11.17s-1.38,11.16-3.07,11.16Z" />
                    <path class="base-color-shadow" d="M3.06,15C1.37,15,0,20,0,26.13S1.37,37.29,3.06,37.29Z" />   
                ...
                <g class="title-group" :class="{'yellow-color': this.isCoverOpened}">
                    ...
                    <path class="logo-out-circle-color" d="M99.88,51v2.44h7.18v6.84a.85.85,0,0,0,.86.86h3.92a.85.85,0,0,0,.86-.86V53.39h7.18V51Z" />                      
                </g>
            </svg>
        </div>        
    </div>
...
<style scoped lang="scss">
    ...
    .base-color{fill:#084caf;}
    .base-color-shadow{fill:#034593;}
    .logo-out-circle-color{fill:#edd21c;}
    .logo-icon-color{fill:#ef2a0a;}
    .screen{fill:#757577;}
    .handle-color,.screen {fill:#70706f;}
    .directional-pad-arrow, .handle-color-shadow{fill:#4f4f4d;}
    .slider-light{fill:#aeb2ad;}
    .base-color-shadow2{fill:#044484;}
    .frame-slider, .slide-cover-light, .frame-light{fill:#aeb2ad;}
    .frame-color{fill:#ccc;}
    .logo-out-circle-color {
        font-size:8.89px;
